...
export default function Account() {
  ...
  return (
    <section>
      <div className="px-4 mx-auto bg-gray-100 sm:px-6 lg:px-8">
        <div className="bg-white shadow">
          <div className="p-6 sm:p-12">
            ...
            <button onClick={()=>router.push('/orders')} className="inline-block px-5 py-3 mt-5 text-xs font-medium tracking-wide text-white uppercase bg-black">
              View Your Orders
            </button>
            <div className="mt-6">
              <h1 className="text-lg font-bold">Your Addresses :</h1>
              {pageLevelLoader ? (
                <PulseLoader
                  color={"#000000"}
                ...
                <div className="flex flex-col gap-4 mt-4">
                  {addresses && addresses.length ? (
                    addresses.map((item) => (
                      <div className="p-6 border" key={item._id}>
                        ...
                        <button
                          ...
                          className="inline-block px-5 py-3 mt-5 text-xs font-medium tracking-wide text-white uppercase bg-black"
                        >
                          {componentLevelLoader &&
            ...
            {showAddressForm ? (
              <div className="flex flex-col items-center justify-center pt-4 mt-5">
